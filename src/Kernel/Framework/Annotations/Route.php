...
class Route
{
     ...
     * @param bool $guarded Indique si la route est protégée ou non.
     *
    ...
    public function __construct(
        ...
        private readonly bool $guarded = false
    )
    {
    ...
    /**
     * Indique si la route est protégée ou non.
     *
     * @return bool Vrai si la route est protégée, faux sinon.
     */
    public final function isGuarded(): bool
    {
        return $this->guarded;
    }
